...
property of the `<Video/>` component to `true`. If it is set to false, you will still have transparency during preview, but the rendered video will not be transparent.
