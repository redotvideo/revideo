...
The Revideo Saas Template ([Github](https://github.com/redotvideo/revideo-saas-template/tree/main)) is a minimal example of a web app built with Revideo. This example application lets users generate Youtube Shorts from a text description.
...
For more information and instructions on how to run the app, check out its [repository](https://github.com/redotvideo/revideo-saas-template/tree/main).
