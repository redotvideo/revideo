...
After agreeing to install the `@revideo/create` package and choosing a project path (`<project-path>`), navigate to your project and install all dependencies:
  ...
  ```shell
   ...
   [http://localhost:9000/](http://localhost:9000/). Here you should see the video shown below. On the [next page](/basic-example), we're going to take a look at the code of this example.
